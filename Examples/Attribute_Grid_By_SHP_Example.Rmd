                                            ...
                                            example)
{
  ...
  if(example == FALSE){
    ...
    if(export_as_grid == TRUE){
      ...
      values(starting_raster) <- values
      example_raster <<- starting_raster
      # -------------------------------------------------------------------------------------
    }
  }
}
...
```{r, runfunc, message = FALSE, error = FALSE}
# -------------------------------------------------------------------------------------
# Run function
...
```{r inputraster, message = FALSE, error = FALSE, fig.height = 10, fig.width = 8}
# -------------------------------------------------------------------------------------
# Run function
Attribute_Grid_By_SHP(out_dir = '',
                      out_name = '',
                      ...
                      starting_values = example_raster,
                      export_as_grid = TRUE,
                      export_long_format = TRUE,
                      is_raster = TRUE,
                      grid_dims = c(10,10),
...
```{r, afterinputraster, message = FALSE, error = FALSE, fig.height = 10, fig.width = 8}
# -------------------------------------------------------------------------------------
# Plot 3
plot(example_raster,
     col = rev(sequential_hcl(n = 100, palette = 'Reds')),
