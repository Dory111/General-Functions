...
<br/>
<br/>
The function can also take in a raster as the starting values. This time we will set the replacement value to 100, the starting values to the raster we generated above, and cells to only have their value replaced when they are fully engulfed (to make the visualization more obvious).
